...
defineRoutes("/api/tazay/contas-pagar", (router) => {
  router.private.get(
    "/documentos-fiscais",
    { permission: TAZAY_PERMISSIONS.OPERATION_READ },
    async (req, res) => {
  ...
  router.private.post(
    "/reconciliar",
    { permission: TAZAY_PERMISSIONS.FINANCE_EXECUTE },
    async (req, res) => {
  ...
  router.private.post(
    "/compras/:id/aprovar",
    { permission: TAZAY_PERMISSIONS.APPROVAL_EXECUTE },
    async (req, res) => {
  ...
  router.private.get(
    "/contas",
    { permission: TAZAY_PERMISSIONS.FINANCE_READ },
    async (req, res) => {
  ...
  router.private.delete(
    "/contas/:id/documentos/:documentoId",
    {
      permission: TAZAY_PERMISSIONS.FINANCE_EXECUTE,
  ...
  router.private.post(
    ...
    { permission: TAZAY_PERMISSIONS.CONFIGURATION_MANAGE },
    async (_req, res) => {
